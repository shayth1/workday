...
<div class="container">
    <div class="row">
        ...
        <div class="col-lg-7">
            <form class="form-auth" action="includes/profile-edit.inc.php" method="post" enctype="multipart/form-data"
                autocomplete="off">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="username" name="username" class="form-control" placeholder="Username"
                        value="<?php echo xss_filter($_SESSION['username']); ?>" autocomplete="off">
                    <sub class="text-danger">
                        <?php
                ...
                <div class="form-group mt-4">
                    ...
                    <input type="number" id="headline" name="headline" class="form-control" placeholder="headline"
                        value="<?php echo xss_filter($_SESSION['headline']); ?>">
                </div>
